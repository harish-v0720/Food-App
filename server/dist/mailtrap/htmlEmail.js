...
exports.htmlContent = `
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <h2>Hello,</h2>
                <p>Thank you for registering with Foodie Faster. To complete your registration, please verify your email address by entering the following verification code:</p>
                <div class="code">{verificationToken}</div>
                <p>If you did not request this verification, please ignore this email.</p>
            </div>
            <div class="footer">
                <p>&copy; 2025 Foodie Faster. All rights reserved.</p>
            </div>
        </div>
    </body>
    </html>
            ...
            <body>
              <div class="email-container">
                <div class="email-header">
                  <h1>Welcome to Foodie Faster!</h1>
                </div>
                <div class="email-body">
                  <p>Hi ${name},</p>
                  <p>Congratulations! Your email has been successfully verified.</p>
                  <p>We are excited to have you on board at Foodie Faster. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>The Foodie Faster Team</p>
                </div>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The Foodie Faster Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2025 Foodie Faster. All rights reserved.</p>
            </div>

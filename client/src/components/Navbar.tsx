...
import { HandPlatter, Loader2, Menu, Moon, PackageCheck, ShoppingCart, SquareMenu, Sun, User, User2, UtensilsCrossed } from "lucide-react";
      ...
      <div className="flex items-center justify-between h-14">
        ...
        <div className="hidden md:flex items-center gap-10">
         ...
         <div className="flex items-center gap-4">
           ...
           <div>
            {
            loading ? (<Button className="bg-orange hover:bg-hoverOrange"> <Loader2 className="mr-2 h-4 w-4 animate-spin"/> Please Wait</Button>)  : ( <Button className="bg-orange hover:bg-hoverOrange">Logout</Button>) 
            }
           </div>
          </div>
        </div>
  ...
  return(
    ...
    <SheetContent className="flex flex-col">
      <SheetHeader className="flex flex-row items-center justify-between mt-2">
        ...
        <SheetTitle><SheetClose asChild><Link to="/">Foodie Faster</Link></SheetClose></SheetTitle>
      ...
      <SheetFooter className="flex flex-col gap-4">
        <div className="flex flex-row items-center gap-2">
          ...
          <h1 className="font-bold">Valpasani Harish</h1>
        </div>
        <SheetClose asChild>
